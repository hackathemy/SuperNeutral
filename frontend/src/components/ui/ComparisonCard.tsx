      ...
      <div className="grid md:grid-cols-2 divide-x divide-gray-200 dark:divide-gray-700">
        ...
        <div className="p-8 bg-gray-50 dark:bg-gray-900">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-gray-400">Idle Funds</span>
              <span className="font-semibold text-gray-500">0%</span>
            </div>
        ...
        <div className="p-8 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950 dark:to-purple-950 relative">
          ...
          <div className="text-center mb-6">
            <div className="text-indigo-600 dark:text-indigo-400 text-sm font-medium mb-2">Innovative Yield Structure</div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-700 dark:text-gray-300">Idle Funds (sPYUSD)</span>
