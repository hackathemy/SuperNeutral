...
export const EthereumLendingPoolABI = [
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract IStETHVault",
        "name": "",
        "type": "address"
      }
    ],
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract StakedPYUSD",
        "name": "",
        "type": "address"
      }
    ],
